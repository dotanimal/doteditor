...
export class PcColorpaletteController extends ColorpaletteController {
	//=============================================
	// TODO
	//=============================================
	//=============================================
	...
	constructor(state:State) {
		...
		let topEle:HTMLElement = <HTMLElement>document.querySelector('#colorpalettePicker');
		let boxContainerEle:HTMLElement = <HTMLElement>document.querySelector('#colorpaletteBoxContainer');
	...
	private _onClickBoxHandler = (e:Event) =>{
		...
		for(box of this._boxList){
			if(box == <Box>e.target){
				box.active();
				//if(this._current.hexColor != box.hexColor){
	...
	public override setHexColorList = (arr: Array<string>):void => {
	...
	public override changedState = ():void =>{
